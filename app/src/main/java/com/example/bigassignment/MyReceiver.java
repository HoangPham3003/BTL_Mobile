    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction().equalsIgnoreCase("com.akashmanna.rem")) {
            ...
            if(b.getString("SetNotify").equalsIgnoreCase("SetNotification")){
                Intent intent_notification = new Intent(context, NewNoteActivity.class);
                ...
                NotificationCompat.Action action =
                        new NotificationCompat.Action.Builder(R.drawable.reminder_icon,
                                "STOP", pendingSwitchIntent)
                                .build();
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNELID)
                        ...
                        .setContentText(b.getString("Noti_Desc"))
